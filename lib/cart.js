// Cart is scoped per user: key = tobaki_cart_<userId> or tobaki_cart_guest
...
function cartKey(userId) {
  if (!userId) return 'tobaki_cart_guest'
  return `tobaki_cart_${userId}`
}
 ...
 *   flavor, nicotineLevel, puffCount, priceAed,
