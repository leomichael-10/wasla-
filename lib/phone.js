...
/**
 * Normalize an Egyptian mobile number to E.164 (+201XXXXXXXX). Accepts
 * 01XXXXXXXXX, +201XXXXXXXX, 00201XXXXXXXX, or 201XXXXXXXX, tolerant of
 * Arabic-Indic digits and spaces/dashes. Returns null if not a valid
 * Egyptian mobile number.
 */
export function toE164Egypt(value) {
