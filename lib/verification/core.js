...
/** Generates, hashes, and stores a new code. Returns the plaintext code (caller sends it, never stores it). */
export async function issueCode(channel, target, purpose) {
