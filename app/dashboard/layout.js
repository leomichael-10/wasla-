      ...
      <div className="flex flex-1 w-full max-w-7xl mx-auto px-4 py-6 gap-6">
        ...
        >
          ...
          <div className="mb-5 pb-4 border-b border-gray-100">
            ...
            <span className="inline-block mt-1.5 text-[10px] font-bold bg-teal-50 text-teal-700 px-2 py-0.5 rounded-full uppercase tracking-wide">
              {user.role}
            </span>
          </div>
          ...
          <div className="mt-4 pt-4 border-t border-gray-100">
            <Link
              href="/"
              className="flex items-center gap-2 text-xs text-gray-400 hover:text-teal-600 font-semibold transition-colors"
            >
              ← Back to store
            </Link>
          </div>
