...
function NavIcon({ name, className = 'w-4 h-4' }) {
  const paths = {
    ...
    wallet: (
      <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a2.25 2.25 0 0 0-2.25-2.25H15a3 3 0 1 0 0 6h3.75A2.25 2.25 0 0 0 21 13.5v-1.5ZM21 12V8.25A2.25 2.25 0 0 0 18.75 6H4.5A2.25 2.25 0 0 0 2.25 8.25v9A2.25 2.25 0 0 0 4.5 19.5h14.25A2.25 2.25 0 0 0 21 17.25V16.5M15 12h.008v.008H15V12Z" />
    ),
  }
...
const NAV = [
  ...
  { href: '/dashboard/settings', icon: 'settings',  label: 'Delivery Settings' },
]
      ...
      <div className="flex flex-1 w-full max-w-7xl mx-auto px-4 py-6 gap-6">
        ...
        >
          ...
          <div className="mb-5 pb-4 border-b border-gray-100">
            ...
            <span className="inline-block mt-1.5 text-[10px] font-bold bg-brand-50 text-brand-700 px-2 py-0.5 rounded-full uppercase tracking-wide">
              {user.role}
            </span>
          </div>
                ...
                <Link
                  ...
                  className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-all ${
                    active
                      ...
                      : 'text-gray-600 hover:bg-[#FBF6EF] hover:text-gray-900'
                  }`}
                >
          ...
          <div className="mt-4 pt-4 border-t border-gray-100">
            <Link
              href="/"
              className="flex items-center gap-2 text-xs text-gray-400 hover:text-brand-700 font-semibold transition-colors"
            >
              ← Back to store
            </Link>
          </div>
