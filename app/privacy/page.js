...
export const metadata = {
  title:       'Privacy Policy — Tobaki',
  description: 'How Tobaki collects, uses, and protects your personal data.',
}
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 space-y-8 text-sm text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-2">When you use Tobaki we may collect:</p>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-600">
              ...
              <li>With authorities: if required by UAE law or court order</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              minimum of 5 years to comply with UAE commercial regulations. You may request deletion of your account
