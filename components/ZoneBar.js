...
export default function ZoneBar() {
  ...
  return (
    <button
      ...
      className="w-full bg-purple-800/95 text-white text-xs sm:text-sm font-semibold px-4 py-2 flex items-center justify-center gap-2 hover:bg-purple-800 transition-colors"
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-3.5 h-3.5 shrink-0 text-amber-300">
